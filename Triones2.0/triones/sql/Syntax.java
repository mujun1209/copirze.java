...
*/
public static final String FIELD_APART = ",";
...
* @return 预编译INSERT语句.
*/
	public static String prepareInsert(String table,String[] colNames)
...
* @return 预编译的UPDATE语句.
*/
	public static String prepareUpdate(String table,String[] colNames)
...
* @return 预编译DELETE语句.
*/
	public static String prepareDelete(String table)
...
* @return 预编译查询语句.
*/
	public static String prepareSelect(String table,String[] computes)
...
*/
	public static final String[] CNDRELATION_SYNTAX = {" AND "," OR "};	
...
*/
	public static final String[] SORT_SYNTAX = {" ASC"," DESC"};
...
* @return 查询语句.
*/
	public static String toSELECT(String table,String computeSyntax)
...
* @return 删除语句.
*/
	public static String toDELETE(String table)
...
* @return 新增语句.
*/
	public static String toINSERT(String table,String colSyntax,String valSyntax)
...
* @return 修改语句.
*/
	public static String toUPDATE(String table,String setSyntax)
	{	return "UPDATE " + table + 
									" SET " + setSyntax;	
	}
...
* @return 条件语句.
*/
	public static String toWHERE(String cndSyntax)
...
* @return 排序语句.
*/
	public static String toORDERBY(String sortSyntax)
...
* @return 分组语句.
*/
	public static String toGROUPBY(String groupSyntax)
	{	return (StringMethod.isValid(groupSyntax)?" GROUP BY " + groupSyntax:"");
	}
	
/**
* 分组条件语句（创建于 2003.03.17）.
<P><DL>
<DT><B>说明：</B><DD>
<pre>
having Syntax中如果有多个分组表达式，用and/or分隔.
如果groupSyntax为null或无效字符串，则返回空字符串.
</pre>
<DT><B>示例：</B><DD>
<pre>
...
* @return 分组语句.
*/
	public static String toHAVING(String groupSyntax)
	{	return (StringMethod.isValid(groupSyntax)?" HAVING " + groupSyntax:"");
	}
...
* @return 占位符列表.
*/
	public static String toBindSyntax(int num)
...
* @return 新条件语句.
*/
	public static String appendCondition(String cndSyntax,int cndRelation,String cndExpression)
...
*/
public static boolean isValidCndRelation(int cndRelation)
...
* @return true代表合法,false代表非法.
*/
public static boolean isValidSort(int mode)
...
*/
	public static void verifyCndRelation(int cndRelation)
...
* @param mode 排序符.
*/
	public static void verifySort(int mode)
...
*/
	public static boolean isSQLSelect(String sql)
...
/**
* 取SELECT语句中的库表（创建于 2003.03.13）.
<P><DL>
<DT><B>说明：</B><DD>
<pre>
如果SELECT语句不正确，则返回空字符串。
</pre>
<DT><B>示例：</B><DD>
<pre>
略
...
* @return 库表.
*/
	public static String getSQLSelectTable(String sql)
	{	int li_pos;
		String ls_sql = (sql + "").toUpperCase();
		String ls_table = "";
...
* @return 库表.
*/
	public static String getSQLUpdateTable(String sql)
	{	int li_pos;
		String ls_sql = (sql + "").toUpperCase();
		String ls_table = "";

		li_pos = ls_sql.indexOf("UPDATE ");

		if(li_pos >= 0)
		{ ls_table = sql.substring(li_pos + 7);
		  ls_sql = ls_table.toUpperCase();
		  li_pos = ls_sql.indexOf(" SET ");
		  if(li_pos > 0) ls_table = ls_table.substring(0,li_pos);
		  ls_table = ls_table.trim();
		}
...
/**
* 取SQL语句中的WHERE子句（创建于 2003.03.13）.
<P><DL>
<DT><B>说明：</B><DD>
<pre>
如果SQL语句不正确，则返回空字符串。
...
* @return 库表.
*/
	public static String getSQLWhere(String sql)
	{	int li_pos;
		String ls_sql = (sql + "").toUpperCase();
		String ls_condition = "";
		...
		if(li_pos > 0)
		{ ls_condition = sql.substring(li_pos + 6);		  
		}
...
* @return 列名清单.
*/
	public static String[] getSQLSelectFields(String sql)
	{	int li_pos;
		String ls_sql = (sql + "").toUpperCase();
		String ls_fields = "";
...
/**
* 取UPDATE语句中的列名清单（创建于 2003.03.13）.
<P><DL>
<DT><B>说明：</B><DD>
<pre>
如果UPDATE语句不正确，则返回空字符串。
列名清单中如有空字符串元素，则说明UPDATE语句不正确。
</pre>
<DT><B>示例：</B><DD>
<pre>
略
...
* @return 列名清单.
*/
	public static String[] getSQLUpdateFields(String sql)
	{	int li_pos;
		String ls_sql = (sql + "").toUpperCase();
		String ls_fields = "";
		...
		if(li_pos >= 0)
		{ ls_fields = sql.substring(li_pos + 5);
		...
		//取字段
		for(int i=0;i<lfields.length;i++)
		{	li_pos = lfields[i].indexOf('=');
			lfields[i] = lfields[i].substring(0,li_pos);
			lfields[i] = lfields[i].trim();
		}
