...
*/
class DriverDataSource //extends DBResource
...
<pre>
创建于 2003.03.06.
修改于 2003.03.08 - 新增Sybase Sqlserver.
修改于 2003.03.16 - 新增DB2.
</pre>
</DL>
...
/**<img src="new2.gif" width="35" height="15" border="0">与驱动程序对应的协议名称（创建于2003.03.06）.
<DL>
<DT><B>说明：</B><DD>
<pre>
略
...
*/
	...
	/**
	 * 根据支持的数据库类型和数据库地址生成数据库的URL（创建于2003.03.06）.
	<P><DL>
	<DT><B>说明：</B><DD>
	<pre>
	略
...
/**
* 判断指定的数据库驱动类是否有效（创建于 2003.03.11）.
<P><DL>
<DT><B>说明：</B><DD>
<pre>
...
/**
* 根据数据库驱动类名查找其对应的数据库类型（创建于 2003.03.11）.
<P><DL>
<DT><B>说明：</B><DD>
<pre>
略
