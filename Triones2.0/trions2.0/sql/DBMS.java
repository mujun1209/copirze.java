...
* @see #ODBC
	...
	@see #SYBSQLSERVER
*/
	static String[] SUPPORTED_DBMS = {"odbc","oracle","mssqlserver","mysql","sybsqlserver","db2","postgresql"};
...
*/
	...
	static boolean isSupportedDBMS(int dbms)
...
*/
	...
	* @return 是或不是JDBC支持的数据库变量类型.
		@see #SUPPORTED_FIELD_TYPE
	*/	
	static boolean isSupportedFieldType(Class fieldType)
	...
	*/
	static String[] CONST_TABLE = {"","dual","","db","systable",""};
...
*/
	static String toSQL(int dbms,String preparedSQL,List values)
	{ int li_pos=0,i=0;
...
* @return 设定记录数范围的SQL.
*/
	static String toRangeSQL(int dbms,String sqlSelect,int beginIndex,int rows)
	{	switch(dbms)
...
* @return 转换后的SQL语句.
*/
	static String toRealSQL(int dbms,String sql)
	{	String[] functions;
		switch(dbms)
